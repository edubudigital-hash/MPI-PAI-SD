...
import { 
  ...
  EVALUASI_P2_BS, 
  EVALUASI_P2_ESSAY 
} from '../../data/kelas4Pembelajaran2Data';
...
interface EvaluasiView4P2Props {
  grade: number;
  lesson: number;
}

export const EvaluasiView4_P2: React.FC<EvaluasiView4P2Props> = ({ grade, lesson }) => {
  ...
  const handleDownloadEvaluasi = () => {
    ...
    let bodyHtml = `
      <div class="header">
        ...
        <p>Soal Berbasis HOTS & Computational Thinking • Kurikulum Merdeka BAB 3</p>
      </div>
    ...
    printOrDownloadDocument(`Evaluasi_PAI_Kelas_${grade}_P${lesson}`, `Evaluasi Asmaul Husna Kelas ${grade}`, bodyHtml);
  };
      ...
      <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 text-white rounded-3xl p-6 shadow-xl border-2 border-amber-300/40 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <h3 className="text-xl sm:text-2xl font-black pt-0.5">
              Kelas {grade} • Pembelajaran {lesson} (BAB 3)
            </h3>
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-2xl bg-emerald-700 hover:bg-emerald-800 text-white font-extrabold text-xs sm:text-sm flex items-center space-x-2 shadow-md border border-emerald-500 transition active:scale-95 cursor-pointer"
          >
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 rounded-xl border text-left text-xs transition flex items-center space-x-2.5 cursor-pointer ${
                          isChecked
                            ? 'bg-teal-600 text-white border-teal-500 font-extrabold shadow-sm'
                            : 'bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:bg-teal-50/50'
                        }`}
                      >
                        <div className={`w-4 h-4 rounded-sm border flex items-center justify-center shrink-0 ${isChecked ? 'bg-white text-teal-600' : 'border-slate-400'}`}>
            ...
            <div key={q.id} className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
              <div className="space-y-1">
                ...
                <div className="text-xs sm:text-sm font-bold text-slate-800 dark:text-slate-200">
                  {q.leftText} {q.leftArabic && <span className="font-arabic text-xl text-emerald-600 font-bold ml-1">({q.leftArabic})</span>}
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 max-w-md w-full border-2 border-amber-300 shadow-2xl text-center space-y-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500">
                Kelas {grade} Pembelajaran {lesson} (Asmaul Husna BAB 3)
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 dark:from-slate-800 dark:to-slate-800/80 border border-amber-200 dark:border-slate-700">
              ...
              <p className="text-xs font-bold text-emerald-600 dark:text-emerald-400 pt-2">
                {calculatedScore >= 80
                  ? '🌟 Sangat Baik! Pemahaman Asmaul Husna Sangat Sempurna!'
                  : calculatedScore >= 60
                  ? '👍 Baik! Teruskan Berlatih & Murojaah.'
                  : '💪 Perlu Lebih Banyak Berlatih Meneladani Asmaul Husna.'}
              </p>
            </div>
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs cursor-pointer flex items-center gap-1.5"
              >
