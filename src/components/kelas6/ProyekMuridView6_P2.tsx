...
import { PROYEK_TASKS_KELAS6_P2 } from '../../data/kelas6Pembelajaran2Data';
...
interface ProyekMuridView6_P2Props {
  grade: number;
  lesson: number;
}

export const ProyekMuridView6_P2: React.FC<ProyekMuridView6_P2Props> = ({ grade, lesson }) => {
  const handlePrint = () => {
    soundFX.playClick();
    ...
    const htmlContent = `
      ...
      <html>
        <head>
          <title>Penugasan Proyek Murid - Kelas ${grade} Bab ${lesson}: Asmaul Husna</title>
          <style>
        ...
        <body>
          ...
          ${PROYEK_TASKS_KELAS6_P2.map((t, idx) => `
            <div class="task-card">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {PROYEK_TASKS_KELAS6_P2.map((task, idx) => (
          <div 
            key={task.id}
