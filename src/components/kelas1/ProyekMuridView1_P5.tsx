...
import { PROYEK_KELAS1_P5 } from '../../data/kelas1Pembelajaran5Data';
...
interface ProyekMuridView1_P5Props {
  grade?: number;
  lesson?: number;
}

export const ProyekMuridView1_P5: React.FC<ProyekMuridView1_P5Props> = ({
  grade = 1,
  lesson = 5,
}) => {
      ...
      <html>
        ...
        <body>
          <div class="header">
            ...
            <p>PAI & Budi Pekerti SD Kelas ${grade} • Pembelajaran ${lesson}: Kisah Nabi Adam a.s. dan Meneladani Akhlaknya</p>
          </div>

          ${PROYEK_KELAS1_P5.map(
            (p, idx) => `
            <div class="card">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-bold px-2.5 py-0.5 bg-amber-100 text-amber-800 rounded-full">
              PjBL & PBL Kelas 1 Pembelajaran 5
            </span>
            <h3 className="text-xl font-black text-slate-800 mt-1">
              Proyek Murid & Pemecahan Masalah
            </h3>
            <p className="text-xs text-slate-500">
              4 Penugasan Berbasis Proyek (2 PjBL) dan Masalah (2 PBL) Kisah Nabi Adam a.s.
            </p>
          </div>
        </div>
