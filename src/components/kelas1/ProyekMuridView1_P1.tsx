...
import { PROYEK_KELAS1_P1 } from '../../data/kelas1Pembelajaran1Data';
...
interface ProyekMuridView1_P1Props {
  grade?: number;
  lesson?: number;
}

export const ProyekMuridView1_P1: React.FC<ProyekMuridView1_P1Props> = ({
  grade = 1,
  lesson = 1,
}) => {
      ...
      <html>
        ...
        <body>
          <div class="header">
            ...
            <p>PAI & Budi Pekerti SD Kelas ${grade} • Pembelajaran ${lesson}: Membaca & Menulis Huruf Hijaiyah</p>
          </div>

          ${PROYEK_KELAS1_P1.map(
            (p, idx) => `
            <div class="card">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xs font-bold px-2.5 py-0.5 bg-amber-100 text-amber-800 rounded-full">
              PjBL & PBL Kelas 1 Pembelajaran 1
            </span>
            <h3 className="text-xl font-black text-slate-800 mt-1">
              Proyek Murid & Pemecahan Masalah
            </h3>
            <p className="text-xs text-slate-500">
              4 Penugasan Berbasis Proyek (2 PjBL) dan Masalah (2 PBL) Mengenai Hijaiyah & Makhraj
            </p>
          </div>
        </div>
